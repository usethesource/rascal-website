...
Rascal's VScode extension comes with a high-level [Language Server Protocol API]((org.rascalmpl.rascal-lsp)) builtin. It can be used to rapidly develop an IDE for your own domain specific language or programming language.
...
* It is easy to add many many useful commands and features for yours users, but all of them have to have a clear and predictable semantics and
all of them must be maintained in the future. It makes sense to create services "on demand", as your users ask for them.
