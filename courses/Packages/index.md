...
:::tip
* What is the ((RascalPackageDirectory)) anyway?
...
| Typepal      | [typepal](/docs/Packages/org.rascalmpl.typepal) | Generic name and type analysis framework; to be factored in to the standard library soon |
