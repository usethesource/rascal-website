---
title: API documentation for Rascal modules
---

#### Synopsis

The Tutor compiler reads Rascal source files and produces intermediate ((Concept)) markdown files 
...
More information about the tags can be found here in ((SourceCodeMarkup)).
