...
The ((Markup)) syntax of a tutor concept file is documented [here]((Markup)) and the 
standard structure of a ((Concept)) file is documented [here]((Concept)). Here we talk
about the file and directory structure of a tutor course.
