---
title: (Executable) code fragments
keywords:
    - rascal-shell
    - listing
    - source
...
Create inline and block code fragments, some of which executed and tested.

#### Syntax

This is for inline code fragments, without highlighting or execution:
``````
`MarkedText`
``````

What follows are more advanced uses of the Rascal parser, highlighting and even execution:
