---
title: Executable code examples
keywords:
    - rascal-shell
    - listing
    - source
...
Code examples in tutor documentation can be executed and tested, and generate screenshots

#### Syntax

#### Syntax

Inline code fragments (are not parsed or highlighted or executed):
...
* Inline code is not parsed or tested
