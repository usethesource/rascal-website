...
- A Java JDK 11 installation is required. A Java run-time environment (JRE) will not be enough, Java 8 or 9 is not high enough, and Java 13 is currently too high.
