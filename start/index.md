...
<p class="text-center">
   ...
   <a class="btn" href="http://update.rascal-mpl.org/console/rascal-stable.jar"><i class="icon-download"></i> Commandline REPL Jar File</a>
</p>
...
You can download the fully contained jar file [here](http://update.rascal-mpl.org/console/rascal-stable.jar).
