...
*  execute an [Insert][Insert](../../Rascal/Statements/Insert) statement that replaces the current element;
*  execute a [Fail][Fail](../../Rascal/Statements/Fail) statement that causes the match for 
...
[ColoredTrees][ColoredTrees](../../Recipes/Common/ColoredTrees) and [Derivative][Derivative](../../Recipes/Common/Derivative).
