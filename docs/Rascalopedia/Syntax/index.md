...
In linguistics, a [Grammar](../../Rascalopedia/Grammar/index.md) is a concept that includes syntax.
...
A [Parser](../../Rascalopedia/Parser/index.md) checks that a text in language _L_ indeed adheres 
