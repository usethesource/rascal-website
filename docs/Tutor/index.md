...
* A Rascal code module is a [Concept](../Tutor/Concept/index.md) to the tuturo compiler as well, in order to provide [API](../Tutor/API/index.md) documentation for every Rascal module. The declarations it contains are not sub-concepts but rather sub-sections of that concept.
