...
> <iframe class="rascal-content-frame" style="display: block; width: 100%; height: 100%; resize: both" src="http://localhost:9152/"></iframe>
</div>
...
<div class="rascal-html-output">
> <iframe class="rascal-content-frame" style="display: block; width: 100%; height: 100%; resize: both" src="http://localhost:9153/"></iframe>
</div>
rascal>count;
int: 1
rascal>count = 66;
...
* [Call analysis](#CallAnalysis-CallAnalysis) 
* Table:
...
## Synopsis {#CallAnalysis-CallAnalysis}
Analyzing the call structure of an application.

## Description {#CallAnalysis-CallAnalysis}
...
## Benefits {#CallAnalysis-CallAnalysis}
...
## Pitfalls {#CallAnalysis-CallAnalysis}
...
## Questions {#CallAnalysis-CallAnalysis}
