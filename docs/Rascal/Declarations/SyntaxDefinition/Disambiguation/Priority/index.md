...
The following snippet uses all [Priority](../../../../../Rascal/Declarations/SyntaxDefinition/Disambiguation/Priority/index.md) features:
```rascal
syntax Exp 
  = A: Id
  | B: Number 
