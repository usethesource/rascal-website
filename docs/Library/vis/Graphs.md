...
```
![image](/assets/Library/vis/Graphs_screenshot_32.png)
```rascal-shell
rascal>graph([<x,x+1> | x <- [1..100]] + [<100,1>], \layout=\defaultCircleLayout())
```
![image](/assets/Library/vis/Graphs_screenshot_33.png)
```rascal-shell
```
...
```
![image](/assets/Library/vis/Graphs_screenshot_42.png)
```rascal-shell
```
...
```
![image](/assets/Library/vis/Graphs_screenshot_43.png)
```rascal-shell
```
