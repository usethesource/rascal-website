...
*  to provide the basic building blocks for syntax trees (see [module:Parse tree](../Library/ParseTree.md))
...
In [module:Parse tree](../Library/ParseTree.md), see [Symbol](../Library/ParseTree.md#ParseTree-Symbol), 
