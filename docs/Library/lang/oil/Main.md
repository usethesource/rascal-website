...
A call to the [interpret](/docs//Library/lang/oil/Main#lang::oil::Main-interpret) function will load an OIL expression and 
...
function directly from Java. The [interpret](/docs//Library/lang/oil/Main#lang::oil::Main-interpret) function is used to debug
an OIL expression and eventually we use the [interpret](/docs//Library/lang/oil/Main#lang::oil::Main-interpret) method directly
from Java.
