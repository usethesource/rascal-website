...
intermediate representation which is designed to be produced from [M3](../../../Library/analysis/m3/Core.md#analysis::m3::Core-M3)
models and [module:analysis::m3::AST](../../../Library/analysis/m3/AST.md) for real programming languages. If (and only if) the translation
...
back into [M3](../../../Library/analysis/m3/Core.md#analysis::m3::Core-M3) models or M3 [module:analysis::m3::AST](../../../Library/analysis/m3/AST.md) models.
