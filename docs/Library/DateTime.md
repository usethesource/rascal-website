...
ok
rascal>now();
datetime: $2022-10-05T07:25:18.300+00:00$
```
...
ok
rascal>N = now();
datetime: $2022-10-05T07:25:18.548+00:00$
rascal>splitDateTime(N);
tuple[datetime date,datetime time]: <$2022-10-05$,$T07:25:18.548+00:00$>
```
...
ok
rascal>N = now();
datetime: $2022-10-05T07:25:18.594+00:00$
rascal>incrementYears(N);
datetime: $2023-10-05T07:25:18.594+00:00$
rascal>incrementYears(N, 5);
datetime: $2027-10-05T07:25:18.594+00:00$
```
...
ok
rascal>N = now();
datetime: $2022-10-05T07:25:18.645+00:00$
rascal>incrementMonths(N);
datetime: $2022-11-05T07:25:18.645+00:00$
rascal>incrementMonths(N, 5);
datetime: $2023-03-05T07:25:18.645+00:00$
```
...
ok
rascal>N = now();
datetime: $2022-10-05T07:25:18.695+00:00$
rascal>incrementDays(N);
datetime: $2022-10-06T07:25:18.695+00:00$
rascal>incrementDays(N, 5);
datetime: $2022-10-10T07:25:18.695+00:00$
```
...
ok
rascal>N = now();
datetime: $2022-10-05T07:25:18.745+00:00$
rascal>incrementHours(N);
datetime: $2022-10-05T08:25:18.745+00:00$
rascal>incrementHours(N, 5);
datetime: $2022-10-05T12:25:18.745+00:00$
```
...
ok
rascal>N = now();
datetime: $2022-10-05T07:25:18.796+00:00$
rascal>incrementMinutes(N);
datetime: $2022-10-05T07:26:18.796+00:00$
rascal>incrementMinutes(N, 5);
datetime: $2022-10-05T07:30:18.796+00:00$
```
...
ok
rascal>N = now();
datetime: $2022-10-05T07:25:18.853+00:00$
rascal>incrementSeconds(N);
datetime: $2022-10-05T07:25:19.853+00:00$
rascal>incrementSeconds(N, 5);
datetime: $2022-10-05T07:25:23.853+00:00$
```
...
ok
rascal>N = now();
datetime: $2022-10-05T07:25:18.906+00:00$
rascal>incrementMilliseconds(N);
datetime: $2022-10-05T07:25:18.907+00:00$
rascal>incrementMilliseconds(N, 5);
datetime: $2022-10-05T07:25:18.911+00:00$
```
...
ok
rascal>N = now();
datetime: $2022-10-05T07:25:18.958+00:00$
rascal>decrementYears(N);
datetime: $2021-10-05T07:25:18.958+00:00$
rascal>decrementYears(N, 5);
datetime: $2017-10-05T07:25:18.958+00:00$
```
...
ok
rascal>N = now();
datetime: $2022-10-05T07:25:19.015+00:00$
rascal>decrementMonths(N);
datetime: $2022-09-05T07:25:19.015+00:00$
rascal>decrementMonths(N, 5);
datetime: $2022-05-05T07:25:19.015+00:00$
```
...
ok
rascal>N = now();
datetime: $2022-10-05T07:25:19.066+00:00$
rascal>decrementDays(N);
datetime: $2022-10-04T07:25:19.066+00:00$
rascal>decrementDays(N, 3);
datetime: $2022-10-02T07:25:19.066+00:00$
```
...
ok
rascal>N = now();
datetime: $2022-10-05T07:25:19.114+00:00$
rascal>decrementHours(N);
datetime: $2022-10-05T06:25:19.114+00:00$
rascal>decrementHours(N, 5);
datetime: $2022-10-05T02:25:19.114+00:00$
```
...
ok
rascal>N = now();
datetime: $2022-10-05T07:25:19.162+00:00$
rascal>decrementMinutes(N);
datetime: $2022-10-05T07:24:19.162+00:00$
rascal>decrementMinutes(N, 5);
datetime: $2022-10-05T07:20:19.162+00:00$
```
...
ok
rascal>N = now();
datetime: $2022-10-05T07:25:19.216+00:00$
rascal>decrementSeconds(N);
datetime: $2022-10-05T07:25:18.216+00:00$
rascal>decrementSeconds(N, 5);
datetime: $2022-10-05T07:25:14.216+00:00$
```
...
ok
rascal>N = now();
datetime: $2022-10-05T07:25:19.264+00:00$
rascal>decrementMilliseconds(N);
datetime: $2022-10-05T07:25:19.263+00:00$
rascal>decrementMilliseconds(N, 5);
datetime: $2022-10-05T07:25:19.259+00:00$
```
...
ok
rascal>B = now();
datetime: $2022-10-05T07:25:19.321+00:00$
rascal>E = incrementDays(B, 2);
datetime: $2022-10-07T07:25:19.321+00:00$
rascal>createInterval(B, E);
interval: Interval($2022-10-05T07:25:19.321+00:00$,$2022-10-07T07:25:19.321+00:00$)
```
...
ok
rascal>B = now();
datetime: $2022-10-05T07:25:19.375+00:00$
rascal>E1 = incrementHours(B);
datetime: $2022-10-05T08:25:19.375+00:00$
rascal>createDuration(B, E1);
Duration: duration(0,0,0,1,0,0,0)
rascal>E2 = incrementMinutes(B);
datetime: $2022-10-05T07:26:19.375+00:00$
...
ok
rascal>B = now();
datetime: $2022-10-05T07:25:19.427+00:00$
rascal>E = incrementDays(B, 2);
datetime: $2022-10-07T07:25:19.427+00:00$
rascal>I = createInterval(B, E);
interval: Interval($2022-10-05T07:25:19.427+00:00$,$2022-10-07T07:25:19.427+00:00$)
...
ok
rascal>B = now();
datetime: $2022-10-05T07:25:19.479+00:00$
rascal>E = incrementDays(B, 2);
datetime: $2022-10-07T07:25:19.479+00:00$
rascal>daysDiff(B, E);
int: 2
```
...
ok
rascal>B = now();
datetime: $2022-10-05T07:25:19.528+00:00$
rascal>E = incrementDays(B, 2);
datetime: $2022-10-07T07:25:19.528+00:00$
rascal>I = createInterval(B, E);
interval: Interval($2022-10-05T07:25:19.528+00:00$,$2022-10-07T07:25:19.528+00:00$)
rascal>dateRangeByDay(I);
list[datetime]: [$2022-10-05$,$2022-10-06$,$2022-10-07$]
```
...
ok
rascal>N = now();
datetime: $2022-10-05T07:25:19.832+00:00$
rascal>printTime(N);
str: "07:25:19.832+0000"
...
ok
rascal>N = now();
datetime: $2022-10-05T07:25:19.884+00:00$
rascal>printDateTime(N);
str: "2022-10-05 07:25:19.884+0000"
rascal>printDateTime(N, "yyyy-MM-dd\'T\'HH:mm:ss.SSSZZ");
str: "2022-10-05T07:25:19.884+0000"
rascal>printDateTime(N, "YYYY/MM/dd/HH/mm/ss");
str: "2022/10/05/07/25/19"
```
...
ok
rascal>arbDateTime();
datetime: $1996-11-19T11:43:40.000+00:00$
```
