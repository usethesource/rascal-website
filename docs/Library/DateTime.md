...
ok
rascal>now();
datetime: $2022-09-21T16:08:32.570+00:00$
```
...
ok
rascal>N = now();
datetime: $2022-09-21T16:08:32.807+00:00$
rascal>splitDateTime(N);
tuple[datetime date,datetime time]: <$2022-09-21$,$T16:08:32.807+00:00$>
```
...
ok
rascal>N = now();
datetime: $2022-09-21T16:08:32.854+00:00$
rascal>incrementYears(N);
datetime: $2023-09-21T16:08:32.854+00:00$
rascal>incrementYears(N, 5);
datetime: $2027-09-21T16:08:32.854+00:00$
```
...
ok
rascal>N = now();
datetime: $2022-09-21T16:08:32.901+00:00$
rascal>incrementMonths(N);
datetime: $2022-10-21T16:08:32.901+00:00$
rascal>incrementMonths(N, 5);
datetime: $2023-02-21T16:08:32.901+00:00$
```
...
ok
rascal>N = now();
datetime: $2022-09-21T16:08:32.956+00:00$
rascal>incrementDays(N);
datetime: $2022-09-22T16:08:32.956+00:00$
rascal>incrementDays(N, 5);
datetime: $2022-09-26T16:08:32.956+00:00$
```
...
ok
rascal>N = now();
datetime: $2022-09-21T16:08:33.017+00:00$
rascal>incrementHours(N);
datetime: $2022-09-21T17:08:33.017+00:00$
rascal>incrementHours(N, 5);
datetime: $2022-09-21T21:08:33.017+00:00$
```
...
ok
rascal>N = now();
datetime: $2022-09-21T16:08:33.076+00:00$
rascal>incrementMinutes(N);
datetime: $2022-09-21T16:09:33.076+00:00$
rascal>incrementMinutes(N, 5);
datetime: $2022-09-21T16:13:33.076+00:00$
```
...
ok
rascal>N = now();
datetime: $2022-09-21T16:08:33.132+00:00$
rascal>incrementSeconds(N);
datetime: $2022-09-21T16:08:34.132+00:00$
rascal>incrementSeconds(N, 5);
datetime: $2022-09-21T16:08:38.132+00:00$
```
...
ok
rascal>N = now();
datetime: $2022-09-21T16:08:33.192+00:00$
rascal>incrementMilliseconds(N);
datetime: $2022-09-21T16:08:33.193+00:00$
rascal>incrementMilliseconds(N, 5);
datetime: $2022-09-21T16:08:33.197+00:00$
```
...
ok
rascal>N = now();
datetime: $2022-09-21T16:08:33.256+00:00$
rascal>decrementYears(N);
datetime: $2021-09-21T16:08:33.256+00:00$
rascal>decrementYears(N, 5);
datetime: $2017-09-21T16:08:33.256+00:00$
```
...
ok
rascal>N = now();
datetime: $2022-09-21T16:08:33.312+00:00$
rascal>decrementMonths(N);
datetime: $2022-08-21T16:08:33.312+00:00$
rascal>decrementMonths(N, 5);
datetime: $2022-04-21T16:08:33.312+00:00$
```
...
ok
rascal>N = now();
datetime: $2022-09-21T16:08:33.367+00:00$
rascal>decrementDays(N);
datetime: $2022-09-20T16:08:33.367+00:00$
rascal>decrementDays(N, 3);
datetime: $2022-09-18T16:08:33.367+00:00$
```
...
ok
rascal>N = now();
datetime: $2022-09-21T16:08:33.427+00:00$
rascal>decrementHours(N);
datetime: $2022-09-21T15:08:33.427+00:00$
rascal>decrementHours(N, 5);
datetime: $2022-09-21T11:08:33.427+00:00$
```
...
ok
rascal>N = now();
datetime: $2022-09-21T16:08:33.485+00:00$
rascal>decrementMinutes(N);
datetime: $2022-09-21T16:07:33.485+00:00$
rascal>decrementMinutes(N, 5);
datetime: $2022-09-21T16:03:33.485+00:00$
```
...
ok
rascal>N = now();
datetime: $2022-09-21T16:08:33.544+00:00$
rascal>decrementSeconds(N);
datetime: $2022-09-21T16:08:32.544+00:00$
rascal>decrementSeconds(N, 5);
datetime: $2022-09-21T16:08:28.544+00:00$
```
...
ok
rascal>N = now();
datetime: $2022-09-21T16:08:33.605+00:00$
rascal>decrementMilliseconds(N);
datetime: $2022-09-21T16:08:33.604+00:00$
rascal>decrementMilliseconds(N, 5);
datetime: $2022-09-21T16:08:33.600+00:00$
```
...
ok
rascal>B = now();
datetime: $2022-09-21T16:08:33.662+00:00$
rascal>E = incrementDays(B, 2);
datetime: $2022-09-23T16:08:33.662+00:00$
rascal>createInterval(B, E);
interval: Interval($2022-09-21T16:08:33.662+00:00$,$2022-09-23T16:08:33.662+00:00$)
```
...
ok
rascal>B = now();
datetime: $2022-09-21T16:08:33.748+00:00$
rascal>E1 = incrementHours(B);
datetime: $2022-09-21T17:08:33.748+00:00$
rascal>createDuration(B, E1);
Duration: duration(0,0,0,1,0,0,0)
rascal>E2 = incrementMinutes(B);
datetime: $2022-09-21T16:09:33.748+00:00$
...
ok
rascal>B = now();
datetime: $2022-09-21T16:08:33.812+00:00$
rascal>E = incrementDays(B, 2);
datetime: $2022-09-23T16:08:33.812+00:00$
rascal>I = createInterval(B, E);
interval: Interval($2022-09-21T16:08:33.812+00:00$,$2022-09-23T16:08:33.812+00:00$)
...
ok
rascal>B = now();
datetime: $2022-09-21T16:08:33.864+00:00$
rascal>E = incrementDays(B, 2);
datetime: $2022-09-23T16:08:33.864+00:00$
rascal>daysDiff(B, E);
int: 2
```
...
ok
rascal>B = now();
datetime: $2022-09-21T16:08:33.915+00:00$
rascal>E = incrementDays(B, 2);
datetime: $2022-09-23T16:08:33.915+00:00$
rascal>I = createInterval(B, E);
interval: Interval($2022-09-21T16:08:33.915+00:00$,$2022-09-23T16:08:33.915+00:00$)
rascal>dateRangeByDay(I);
list[datetime]: [$2022-09-21$,$2022-09-22$,$2022-09-23$]
```
...
ok
rascal>N = now();
datetime: $2022-09-21T16:08:34.211+00:00$
rascal>printTime(N);
str: "16:08:34.211+0000"
...
ok
rascal>N = now();
datetime: $2022-09-21T16:08:34.263+00:00$
rascal>printDateTime(N);
str: "2022-09-21 16:08:34.263+0000"
rascal>printDateTime(N, "yyyy-MM-dd\'T\'HH:mm:ss.SSSZZ");
str: "2022-09-21T16:08:34.263+0000"
rascal>printDateTime(N, "YYYY/MM/dd/HH/mm/ss");
str: "2022/09/21/16/08/34"
```
...
ok
rascal>arbDateTime();
datetime: $2018-05-29T04:38:55.000+00:00$
```
